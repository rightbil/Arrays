...
import java.util.Scanner;
 ...
 /*1 Array processing;
        ...
        3.	Start from 0 as index
        4.	Get the value at index in step 3
        5.	Add step 4’s value to Sum
        6.	Add 1 to index and check if it is less than the length (step 2)
        7.	Continue step 4,5,6


        2.	Find the mean (average) of the elements of an array

        A.	Set sum = 0
        B.	Get Length of array
        C.	Start from 0 as index
        D.	Get the value at index in step C
        E.	Add step D’s value to Sum
        F.	Add 1 to index and check if it is less than the length (step B)
        G.	Continue step 4,5,6 till index <= length
        H.	Average= sum / length-1*/
